...
-- Records of my_dept
-- ----------------------------
INSERT INTO `my_dept` VALUES (1, 0, '0', '南京总公司', 1, b'1', '2020-08-19 11:01:09', '2020-08-19 11:01:11');
...
INSERT INTO `my_dept` VALUES (7, 5, '0,5', '运维部门', 2, b'1', '2020-08-19 11:08:56', '2020-08-27 14:18:33');
INSERT INTO `my_dept` VALUES (17, 5, '0,5', 'CES', 11, b'1', '2020-08-27 14:18:14', '2020-08-27 14:18:48');
...
CREATE TABLE `my_job`  (
  ...
  `status` bit(1) NULL DEFAULT NULL COMMENT '岗位状态',
  `sort` int(5) NULL DEFAULT NULL COMMENT '排序',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
-- Records of my_job
-- ----------------------------
INSERT INTO `my_job` VALUES (1, '部门经理', b'1', 1, '2020-08-19 11:14:55', '2020-08-19 11:14:57');
INSERT INTO `my_job` VALUES (2, '人事专员', b'1', 2, '2020-08-19 11:15:30', '2020-08-19 11:15:33');
INSERT INTO `my_job` VALUES (3, '普通员工', b'1', 3, '2020-08-19 11:16:19', '2020-08-27 15:24:44');
...
CREATE TABLE `my_log`  (
  `log_id` int(21) NOT NULL AUTO_INCREMENT COMMENT 'id值',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1542 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of my_role
-- ----------------------------
INSERT INTO `my_role` VALUES (1, 'ADMIN', '超级管理员，拥有所有权限', '2020-07-10 09:40:35', '2020-08-26 14:35:53', '1');
...
INSERT INTO `my_user` VALUES (8, 6, 'test6', '$2a$10$2aLbMBdNottSq13J.tfIF.5IFgTcDlWwOQI7btckzsq3vl2KtWOV6', '测试修改', '13556336212', '1454564646@qq.com', 1, '2020-07-10 09:42:36', '2020-08-27 14:02:49');
