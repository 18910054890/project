package com.lyzd.om.shared.service.admin.aspectj;
...
import com.lyzd.om.spring.common.utils.SecurityUtils;
...
import com.lyzd.om.shared.service.admin.annotation.DataPermission;
...
public class DataScopeAspect {
	 ...
	 * 配置织入点
	 */
	@Pointcut("@annotation(com.lyzd.om.shared.service.admin.annotation.DataPermission)")
	...
	public static void dataScopeFilter(JoinPoint joinPoint, JwtUserDto user, String deptAlias, String userAlias) {
		...
		for (MyRole role : user.getRoleInfo()) {
			...
			if (DATA_SCOPE_ALL.equals(dataScope)) {
				...
				sqlString.append(
						StrUtil.format(" OR {}.dept_id IN ( SELECT dept_id FROM my_role_dept WHERE role_id = {} ) ",
